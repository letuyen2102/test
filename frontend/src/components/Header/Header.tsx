...
const Header: React.FC = (props) => {
  ...
  const handleSearch = async (text: string) => {
    try {
      // setSpiner(true)
      const res = await axios.post(`/myway/api/products/search`, {
        query: text,
      });
      if (res.data.status === "success") {
      ...
      <div className={`${styles.HeaderTop} container-lg`}>
        {showMenuMobile && (
          <div
            ...
            onClick={(e) => setShowMenuMobile(false)}
          >
            <div
              className={`${styles.HeaderModalMenu}`}
              ...
              <ul className={`${styles.ul1}`}>
                ...
                {!handleLoginAndCart.token ? (
                  ...
                  <>
                    ...
                    <li>
                      <Link
                        to="/profile/account/user/change-password"
                        onClick={(e) => setShowMenuMobile(false)}
                      >
                        Đổi mật khẩu
                      </Link>
                    ...
                    <li>
                      <Link
                        to="/profile/account/user/myOrder"
                        onClick={(e) => setShowMenuMobile(false)}
                      >
                        Đơn hàng
                      </Link>
        ...
        <div className={`row`}>
          ...
          >
            ...
            <div
              className={`${styles.HeaderTopMenu}`}
              onClick={(e) => setShowMenuMobile(true)}
            >
      ...
      <div className={`${styles.HeaderBottom} container-md ps-lg-5 pe-lg-5`}>
        <div>
          <ul className={`${styles.HeaderBottomUl}`}>
            ...
            <li>
              <Link to="/collection/all">Thời trang</Link>
              {/* <ul className={`${styles.ul1}`}>
                                <li>
                                    <Link to=''>
                                        Đầm
            ...
            <li>
              <Link to="/collection/all">
                Mua sắm theo dịp
                <i
                  className={`fa-solid fa-angle-down ${styles.iconAngleDown}`}
                ></i>
              </Link>
              <ul className={`${styles.ul1}`}>
                <li>
                  <Link to="">
                    Thời trang công sở
                    <i
                      className={`fa-regular fa-angle-right ${styles.iconAngleDown}`}
                    ></i>
                  </Link>
                  <ul>
                    <li>
