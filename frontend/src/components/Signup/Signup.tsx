        ...
        <div className={`row`}>
          <div className={`col-md-6 offset-md-3`}>
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault(), handleSignup(accountSignup);
              }}
            >
              <div className={`${styles.formGroup}`}>
                <label htmlFor="Name">
                  Tên <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="Name"
              ...
              <div className={`${styles.formGroup}`}>
                <label htmlFor="Phone">
                  Số Điện Thoại <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="Phone"
              ...
              <div className={`${styles.formGroup}`}>
                <label htmlFor="Address">
                  Địa chỉ <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="Address"
              ...
              <div className={`${styles.formGroup}`}>
                <label htmlFor="PasswordConfirm">
                  Mật Khẩu Xác Thực <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="PasswordConfirm"
