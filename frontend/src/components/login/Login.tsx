  ...
  const loginGg = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      if (resPost.data.status === "success") {
        ...
        dispatch(
          login({
            tokenDispatch: resPost.data.token,
            userDispatch: userGg,
            timeExpire: resPost.data.timeExpire,
          })
        );
...
const Login: React.FC = () => {
  ...
  const handleLoginNormal = async (objAccount: Account) => {
    try {
      ...
      dispatch(
        handleNotify({
          message: "Thông tin đăng nhập không chính xác , vui lòng thử lại sau",
          show: true,
          status: 400,
        })
      );
  ...
  return (
    <div>
      ...
      <div
        className={`container-md ps-lg-5 pe-lg-5`}
          ...
          <div className={`col-md-6 offset-md-3`}>
            ...
            >
              <div className={`${styles.formGroup}`}>
                <label htmlFor="Email">
                  EMAIL <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="Email"
              ...
              <div className={`${styles.formGroup}`}>
                <label htmlFor="Password">
                  MẬT KHẨU <span style={{ color: "#ec1f27" }}>*</span>
                </label>
                <input
                  id="Password"
                  type="password"
            ...
            <div className={`${styles.forgotPassword}`}>
              ...
              <p>
                ...
                <Link to="/account/signup">TẠI ĐÂY</Link>
              </p>
            </div>
          </div>
        </div>
