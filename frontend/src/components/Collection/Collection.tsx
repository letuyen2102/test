...
const Collection: React.FC<{ queryAPI: string; queryString: string }> = (
  props
) => {
              ...
              <ul>
                <li>
                  <label>
                    <input
                      type="checkbox"
                      checked={searchParams.get("maxPrice") === "1000000"}
                      onChange={(event) => {
                ...
                <li>
                  <label>
                    <input
                      type="checkbox"
                      checked={
                        searchParams.get("minPrice") === "1000000" &&
                ...
                <li>
                  <label>
                    <input
                      type="checkbox"
                      checked={
                        searchParams.get("minPrice") === "3000000" &&
                ...
                <li>
                  <label>
                    <input
                      type="checkbox"
                      checked={searchParams.get("minPrice") === "5000000"}
                      onChange={(event) => {
                        if (event.target.checked) {
                          searchParams.delete("startItem");
                          searchParams.delete("minPrice");
                      ...
                      <li key={index}>
                        <label>
                          <input
                            type="checkbox"
                            checked={
                              searchParams.get(props.queryString) ===
                              slugify(each, { locale: "vi", lower: true })
                            }
                            onChange={(event) => {
                              if (event.target.checked) {
                                searchParams.delete("startItem");
          ...
          <div className={`col-lg-9 col-md-12 col-sm-12 sol-12`}>
            <div className={`${styles.productShop}`}>
              <div className={`${styles.productShopFilter}`}>
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  <label>
                    <input
                      type="checkbox"
                      checked={searchParams.get("sort") === "name"}
                      onChange={(event) => {
                        if (event.target.checked) {
                          searchParams.delete("startItem");
                  ...
                  <label>
                    <input
                      type="checkbox"
                      checked={searchParams.get("sort") === "newPrice"}
                      onChange={(event) => {
                        if (event.target.checked) {
                          searchParams.delete("startItem");
              ...
              <div className="row">
                <PaginatedItems
                  itemsPerPage={8}
                  apiString={props.queryAPI + searchParams.toString()}
                />
